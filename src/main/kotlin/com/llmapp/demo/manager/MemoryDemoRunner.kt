    ...
    override suspend fun run() {
        ...
        agent.startNewTask(
            ...
            initialContext = mapOf(
                ...
                "ограничения" to "Использовать только бесплатные модели KodikRouter",
        ...
        agent.updateWorkingContext("блокеры", "Нужно согласование API ключей KodikRouter")
        agent.updateWorkingContext(
            "выполнено",
        ...
        val projectQuestions = listOf(
            ...
            "Как организовать обработку ошибок при работе с KodikRouter API?",
